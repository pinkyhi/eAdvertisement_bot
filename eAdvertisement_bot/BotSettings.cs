...
namespace eAdvertisement_bot
{
    public static class BotSettings
    {
        ...
        public static string WebHookUrl { get; set; } = "https://31e19372.ngrok.io";    // Part of webhook url that gives ngrok. Command to get it for ssl in IIS Express: ngrok http https://localhost:44360 -host-header="localhost:44360"
