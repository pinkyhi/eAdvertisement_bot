    ...
    public class AddChannelsToAutobuyCommand : Command
    {
        ...
        public async override Task Execute(Update update, TelegramBotClient botClient)
        {
            ...
            try
            {
                ...
                List<DbEntities.Channel> channels = dbContext.Channels.Where(c => c.Price >= intervalFrom && c.Price <= intervalTo && c.Cpm != null && c.Cpm<maxCpm && c.Coverage > 400 && c.Places != null && c.Places.Count > 0).ToList();
