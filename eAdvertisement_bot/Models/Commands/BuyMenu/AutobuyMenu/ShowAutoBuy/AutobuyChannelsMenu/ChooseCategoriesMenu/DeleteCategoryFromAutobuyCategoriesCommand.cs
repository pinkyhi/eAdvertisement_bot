...
{
    public class DeleteCategoryFromAutobuyCategoriesCommand : Command
    {
        public override string Name => "/deleteCategoryFromAutobuyCategoriesPC";
        ...
        public override bool Contains(Update update)
        {
            ...
            else
            {
                ...
                return data.StartsWith("dcgfabcgsP");
            }
        }
        ...
        public async override Task Execute(Update update, TelegramBotClient botClient)
        {
            ...
            {
                MainLogger.LogException(ex, addStr: "DeleteCategoryFromAutobuyCategories");
            }
            finally
            {
                dbContext.Dispose();
