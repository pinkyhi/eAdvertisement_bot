    ...
    public class ChangingAutobuyPostIsAcceptedCommand : Command
    {
        ...
        public async override Task Execute(Update update, TelegramBotClient botClient)
        {
            ...
            try
            {
                ...
                autobuy.Publication_Snapshot = JsonSerializer.Serialize(dbContext.Publications.Include("Media").Include("Buttons").FirstOrDefault(p=>p.Publication_Id==Convert.ToInt32(update.CallbackQuery.Data.Substring(9))));
