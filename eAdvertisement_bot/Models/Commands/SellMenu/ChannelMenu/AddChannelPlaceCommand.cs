...
{
    public class AddChannelPlaceCommand : Command
    {
        public override string Name => "/addAdvPlace";
        ...
        public override bool Contains(Update update)
        {
            ...
            else
            {
                ...
                return data.StartsWith("/addAdvPlace");
            }
        }
        ...
        public override async Task Execute(Update update, TelegramBotClient botClient)
        {
            ...
            {
                MainLogger.LogException(ex, "AddChannelPlaceCommand");
            }
            finally
            {
                dbContext.Dispose();
