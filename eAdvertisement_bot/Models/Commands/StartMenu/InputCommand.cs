    ...
    public class InputCommand : Command
    {
        ...
        public async override Task Execute(Update update, TelegramBotClient botClient)
        {
            try
            {
                ...
                await botClient.SendTextMessageAsync(update.CallbackQuery.Message.Chat.Id, $"Отправьте деньги на QIWI кошелек `380958374332` или QIWI карту `4890 4947 0426 5180` с комментарием:\n\n `{update.CallbackQuery.From}`\n\nПоддержка @olejchanskiy", replyMarkup: new InlineKeyboardMarkup(keyboard), parseMode: Telegram.Bot.Types.Enums.ParseMode.Markdown);
