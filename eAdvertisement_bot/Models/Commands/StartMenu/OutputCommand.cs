    ...
    public class OutputCommand : Command
    {
        ...
        public async override Task Execute(Update update, TelegramBotClient botClient)
        {
            try
            {
                ...
                await botClient.SendTextMessageAsync(update.CallbackQuery.Message.Chat.Id, $"Вывод происходит в ручном режиме через менеджера - @olejchanskiy", replyMarkup: new InlineKeyboardMarkup(keyboard), parseMode: Telegram.Bot.Types.Enums.ParseMode.Markdown);
