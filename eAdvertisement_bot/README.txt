...
4) Open port 44360 on your computer (create rules for brandmaur for ports in two copies for TCP and UDP. This procedure should be done to in and out connections. Next open port throw router)
...
7) Don't forget add initialization of bot in the end of Startup.cs
